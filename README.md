...
Verze 7.0.4 je technicky ověřená produkční serverless varianta. Je připravena k řízenému oficiálnímu používání školou za podmínek popsaných v `PROVOZNI-PRAVIDLA.md`, `SECURITY.md` a `RELEASE-CHECKLIST.md`.
...
- `AUDIT-PRUVODCE-V7.0.1.md` – audit logiky kroků, závislostí a kombinací vydání 7.0.1, jehož opravy zůstávají součástí 7.0.4.
