...
Verze 7.0.6 je technicky ověřená produkční serverless varianta. Je připravena k řízenému oficiálnímu používání školou za podmínek popsaných v `PROVOZNI-PRAVIDLA.md`, `SECURITY.md` a `RELEASE-CHECKLIST.md`.
...
Verze 7.0.6 neřeší školní server, centrální identitu, databázi ani serverovou úschovu API klíče. Přístupová brána v klientském kódu je organizační opatření, nikoli neobejitelná autentizace. Rozpracovaný studentský pokus se po zavření nebo obnovení stránky plně neobnoví. Tyto body musí být zohledněny v provozních pravidlech a později posouzeny se školním IT.
...
Verze 7.0.6 obsahuje Studio Bridge v1. Při otevření s `?studioHandoff=1` převezme krátkodobý anonymní `ghrab-material-v1`, vyplní základní údaje a zdrojový obsah a zobrazí návratový banner. Souborový export zůstává záložní cestou.
