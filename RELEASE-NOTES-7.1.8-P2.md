# Generátor interaktivních testů 7.1.8 — etapa P2
...
- Vratná migrace aplikačních dat do prefixu `ghrab.generator.*`; záloha se vytváří před odstraněním starých klíčů.
...
- PWA cache `ghrab-generator-v7.1.8` a aktualizační zpráva `GHRAB_SKIP_WAITING`.
